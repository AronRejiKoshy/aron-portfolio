...
export default function Lanyard({
  ...
  return (
    <div className="relative z-0 w-full h-[60vh] md:h-screen flex justify-center items-center transform scale-100 origin-center cursor-grab active:cursor-grabbing">
      <Canvas
        camera={{ position, fov }}
...
function Band({
  maxSpeed = 50, minSpeed = 0, isMobile = false, frontImage = null, backImage = null, imageFit = 'cover', lanyardImage = null, lanyardWidth = 1
}: any) {
